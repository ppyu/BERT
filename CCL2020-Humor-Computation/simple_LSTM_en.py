...
def generate_data(data_df, max_length):
    ...
    for i, sentence in enumerate(data_df["Sentence"]):
        for j, word in enumerate(cut_sentence(sentence)):
...
if __name__ == '__main__':
    train_data_df, word_set, vcab_size, max_length = prapare_with_tokenize(train_dev_data_path + "en_train.csv")
    ...
    # test_data_df, _, _, _ = prapare_without_tokenize(train_dev_data_path + "en_dev.csv")
